...
//console.log("Count = " + testData.calls.count());
//console.log(testDataJson);

//Enumerable.from(testData.calls).where(function(i){i.apiName == "shipping-api-v2-live-soap"}).forEach(function(obj)
var matchingCalls = Enumerable.from(testData.calls).selectMany(function(i) {i.apiName !== "shipping-api-v2-live-soap"});
Enumerable.from(testData.calls).where(function(i){i.apiName !== "shipping-api-v2-live-soap"}).log().toJoinedString()

// Enumerable.from(matchingCalls).forEach(function(obj)
// {
//     console.log(i.apiName + ":" + i.uriPath);
...
// Enumerable.range(4, 4).log().toJoinedString();
// console.log("next");
// Enumerable.range(6, 7).log().toJoinedString();
// console.log("next");
// Enumerable.range(4, 4).join(Enumerable.range(6, 7), "", "", "outer,inner=>outer*inner").log().toJoinedString();
